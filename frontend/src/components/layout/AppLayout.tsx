...
// Module-level constants so useJsApiLoader sees a stable reference across renders
// (passing a new array each render makes the hook think config changed and reload).
...
export default function AppLayout() {
  ...
  // If the script doesn't load within 12s, show a "retry" affordance.
  useEffect(() => {
